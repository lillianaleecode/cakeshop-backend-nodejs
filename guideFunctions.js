...
function hello() {
  ...
  //lamda functions (or arrow functions): they are like a mechanism to represent anonymous functions 

    // anonymous function (no naming)
  (function() {
    console.log("I'm an anonymous");
  })();

  //arrow functions have 3 parts:
  // parameters
  // fat arrow notation
  // statements
  ...
  console.log("food: ", food(10, 20, 30)); //will return 60
  ...
  // variation 2
  var food = x => x + 100;
  console.log("food: ", food(10));//will return 110
